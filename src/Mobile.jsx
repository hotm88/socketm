    ...
    return (
        ...
        <div className="bg-white h-screen">
            <div className="border-4 border-solid border-[#502A72] rounded-lg mt-5 md:mx-3 mx-2">
                ...
                <input type="email" name="user_email" className="border-2 border-[#FF9E0F] md:ml-60 md:w-full md:mr-5 ml-16 mr-2 w-full"/></label>
                ...
                <input type="Password" name="user_password" className="border-2 border-[#FF9E0F] md:ml-60 md:w-full md:mr-5 ml-16 mr-2 w-full"/></label>
