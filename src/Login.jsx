               ...
               <div className="md:flex flex flex-row">
                ...
                <div className="bg-[#F8F8F8] md:w-1/2 w-1/2 md:mx-10 m-5rounded-md mb-2">
                    <form action="post" className="md:flex flex flex-col">
                        ...
                        <h6 className="text-[10px] text-[#B7B7B7] text-left md:mx-5 mx-1 font-sans">Need help? Call Socket Technical Support at 1-800-762-5383. We'll be happy to walk you through the new site.</h6>
                    </form>
